...
function DashboardProducts() {
    ...
    const [addToCart, { isAddSuccess }] = useAddToCartMutation();
                    ...
                    <table className="w-full whitespace-nowrap">
                        <thead className="text-xs font-semibold tracking-wide text-left text-[rgb(107,114,128)] uppercase border-b border-[rgb(229,231,235)] bg-[rgb(243,244,246)]">
                            <tr>
                                ...
                                <td className="px-3 py-3 text-center">修改商品</td>
                                <td className="px-3 py-3 text-center">刪除商品</td>
                            ...
                            {dupProduct.slice(pagesVisited, pagesVisited + casesPerPage).map((product) => {
                                return (
                                    <tr>
                                        ...
                                        <td className="px-3 py-3">
                                            <Link to={`/admin/${product._id}/edit`} className="block">
                                                <PencilSquareIcon className="w-5 h-5 mx-auto hover:opacity-70" />
                                            </Link>
                                        </td>
                                        <td className="px-3 py-3">
                                            <button onClick={() => handleDeleteProduct(product._id, user._id)} className="block mx-auto" disabled={isLoading}>
                                                <TrashIcon className="w-5 h-5 mx-auto hover:opacity-70" />
                                            </button>
                                        </td>
